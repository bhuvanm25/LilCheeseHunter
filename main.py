...
def main():
    ...
    num_episodes = 20    # number of episodes to run training loop
    ...
    # Setting up the tracking variables for the learning curve                                           HERE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    rewards_per_episode = []
    steps_per_episode = []
    success_rates = []
    ...
    for episode in range(num_episodes):
        ...
        #After the episode is done, record the statistics:                                                        HERE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!11
        if (step + 1 == max_steps):
    ...
    return rewards_per_episode, steps_per_episode, success_rates


if __name__ == "__main__":
    rewards_per_episode, steps_per_episode, success_rates = main()

#VISUALIZATION                                                                                  HERE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
def training_stats(rewards, steps, success_rates, window = 10):
    ...
    if len(rewards)>= window:
        ...
        plt.plot(np.arange(window-1, window-1+len(moving_avg)), moving_avg)
    ...
    plt.xlabel('Episode')
    plt.ylabel('Steps')
    #plt.ylim([-0.05, 1.05])  # Set y-axis limits for percentage display

    plt.tight_layout()  # Adjust spacing between subplots
    plt.savefig('training_stats.png')
    plt.close()

training_stats(rewards_per_episode, steps_per_episode, success_rates)
